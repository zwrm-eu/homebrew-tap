class Zwrm < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://releases.zwrm.eu/zwrmd/v0.10.23/zwrm-darwin-arm64"
      ...
      url "https://releases.zwrm.eu/zwrmd/v0.10.23/zwrm-darwin-amd64"
  ...
  on_linux do
    if Hardware::CPU.arm?
      url "https://releases.zwrm.eu/zwrmd/v0.10.23/zwrm-linux-arm64"
      ...
      url "https://releases.zwrm.eu/zwrmd/v0.10.23/zwrm-linux-amd64"
